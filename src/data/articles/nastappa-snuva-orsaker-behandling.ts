...
const article: Article = {
  slug: "nastappa-snuva-orsaker-behandling",
  title: "Nästäppa och snuva – orsaker och behandling",
  h1: "Nästäppa och snuva: orsaker, behandling och när du bör söka vård",
  seoTitle: "Nästäppa och snuva: orsaker och behandling",
  metaDescription: "Nästäppa och snuva beror ofta på förkylning eller allergi. Läs om vanliga orsaker, säker egenvård, nässpray och när du bör söka vård.",
  tag: "ÖRON, NÄSA & HALS",
  date: "september 16, 2026",
  publishedAtIso: "2026-09-16",
  image: "/bilder/nastappa-snuva-redaktionell-2026-09-16.svg",
  imageAlt: "Redaktionell illustration av en person hemma med näsduk och tekopp vid nästäppa och snuva.",
  authorName: "Hemläkare.se redaktion",
  targetQuery: "nästäppa och snuva orsaker behandling",
  excerpt: "Nästäppa och snuva är oftast ofarligt och beror på förkylning, men allergi och känsliga slemhinnor är andra vanliga orsaker. Rätt egenvård beror på vad som utlöser besvären.",
  summary: "Nästäppa och snuva uppstår när näsans slemhinna svullnar eller bildar mer sekret än vanligt. Förkylning är en vanlig orsak, men besvären kan också bero på allergi eller så kallad vasomotorisk rinit, där slemhinnan reagerar på exempelvis starka lukter, torr luft eller temperaturväxlingar. Koksalt kan användas för att lindra nästäppa. Avsvällande nässpray kan ge kortvarig lindring men ska användas enligt förpackningens anvisningar och inte längre än rekommenderat, eftersom långvarig användning kan förvärra nästäppan. Sök vård vid långvariga eller ensidiga besvär, blodig snuva eller om en infektion försämras eller ger nya symtom.",
  keyTakeaways: [
    "Förkylning, allergi och känsliga slemhinnor är vanliga orsaker till nästäppa och snuva.",
    "Gult eller grönt snor betyder inte i sig att antibiotika behövs.",
    "Koksalt kan användas för att skölja eller fukta näsan och har inte samma risk för rebound-nästäppa som avsvällande nässpray.",
    "Avsvällande nässpray ska användas kortvarigt och enligt produktens anvisningar.",
    "Kontakta vårdcentral vid återkommande eller långvariga besvär, blodig snuva eller snuva från bara ena näsborren."
  ],
  ...
  faq: [
    ...
    { question: "Betyder grönt snor att jag behöver antibiotika?", answer: "Nej. Snor kan bli gult eller grönt även vid en virusorsakad förkylning. Antibiotika hjälper inte mot vanlig förkylning." },
    { question: "Kan jag använda koksalt varje dag?", answer: "Koksaltlösning används för att fukta eller skölja näsan och är ett alternativ till avsvällande nässpray. Följ produktens instruktioner och använd rent vatten enligt anvisning om du blandar lösning för nässköljning." },
    { question: "Varför blir jag mer täppt när jag slutar med nässpray?", answer: "För lång användning av avsvällande nässpray kan göra nästäppan värre när du slutar. Använd därför sprayen bara så länge och i den dos som anges i produktinformationen." },
    { question: "Hur skiljer sig allergi från förkylning?", answer: "Allergi ger ofta nysningar, klåda och vattnig snuva och kan återkomma i samma miljö eller säsong. Förkylning ger oftare halsont, hosta och sjukdomskänsla." },
    { question: "När är ensidig snuva ett varningstecken?", answer: "1177 rekommenderar kontakt med vårdcentral vid snuva enbart från ena näsborren eller blodig snuva, särskilt om besvären kvarstår." }
  ],
  sources: [
    { title: "Förkylning", publisher: "1177 Vårdguiden", url: "https://www.1177.se/sjukdomar--besvar/infektioner/forkylning-och-influensa/forkylning/" },
    { title: "Vasomotorisk rinit", publisher: "1177 Vårdguiden", url: "https://www.1177.se/sjukdomar--besvar/oron-nasa-och-hals/nasa-och-luktsinne/vasomotorisk-rinit/" },
    { title: "Fem vanliga frågor om förkylning", publisher: "Läkemedelsverket", url: "https://www.lakemedelsverket.se/sv/om-lakemedelsverket/press-och-nyheter/kort-om/sa-behandlar-du-din-forkylning-pa-basta-satt" }
  ],
  cta: {
