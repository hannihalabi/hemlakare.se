...
const allArticles: Article[] = [
  {
    ...
    h1: "Krupp hos barn: symtom och när du ska söka vård",
    seoTitle: "Krupp hos barn: symtom, egenvård och akutråd",
    metaDescription: "Krupp ger skällande hosta och ljudlig inandning, ofta på natten. Läs vad du kan göra hemma, hur vården behandlar och när barnet behöver akut hjälp.",
    tag: "BARNHÄLSA",
    date: "15 september 2026",
    publishedAtIso: "2026-09-15",
    image: "/bilder/artiklar/krupp-barn.webp",
    imageAlt: "Illustration av en vuxen som håller ett litet barn upprätt vid ett öppet fönster på kvällen.",
    authorName: "Hemläkare.se redaktion",
    targetQuery: "krupp hos barn",
    excerpt: "Krupp hos barn ger ofta en plötslig, skällande hosta och pipande ljud vid inandning. Här får du råd för natten och tydliga tecken på när vård behövs.",
    summary: "Krupp hos barn beror på att en virusinfektion svullnar slemhinnan kring struphuvudet. Typiskt är skällande hosta, heshet och ett pipande eller väsande ljud när barnet andas in, ofta efter att barnet har sovit en stund. Sätt barnet upprätt, försök skapa lugn och låt barnet andas sval luft om det känns hjälpsamt. Kontakta genast vård om andningsbesvären inte lättar inom 15–30 minuter. Ring 112 vid mycket svår andning, blå eller blek hud eller andningsbesvär med tydliga indragningar mellan revbenen och i halsgropen.",
    keyTakeaways: [
      "Krupp känns ofta igen på skällande hosta, heshet och ljudlig inandning.",
      "Besvären kommer ofta på kvällen eller natten och är vanligast hos små barn.",
      "Håll barnet upprätt, lugna barnet och prova sval luft; oro och gråt kan göra andningen mer ansträngd.",
      "Andningsbesvär som inte lättar inom 15–30 minuter kräver omedelbar kontakt med vårdcentral eller jourmottagning.",
      "Ring 112 om barnet har mycket svårt att andas, blir blekt eller blåaktigt eller har andningsbesvär med kraftiga indragningar."
    ],
    body: "Krupp hos barn är en reaktion i de övre luftvägarna vid en virusinfektion. Slemhinnan kring stämbanden och strax nedanför svullnar. Eftersom små barn har smalare luftvägar kan en begränsad svullnad ge en tydlig skällande hosta, heshet och ett pipande eller väsande ljud när barnet andas in. Ljudet kallas inspiratorisk stridor.\n\nBesvären börjar ofta på kvällen eller efter några timmars sömn och kan kännas dramatiska. De flesta anfall är lindriga, men andningsbesvär hos barn kan vara svåra att bedöma. Följ därför både andningen och barnets allmäntillstånd. Informationen här är generell och ersätter inte en individuell medicinsk bedömning.",
    sections: [
      {
        id: "symtom-krupp-barn",
        title: "Symtom på krupp hos barn",
        body: [
          "Krupp kan komma efter någon eller några dagar med snuva, halsont eller vanlig hosta, men ibland börjar anfallet plötsligt. Den skällande hostan brukar låta hård och ihålig. Barnet kan bli hest och få ett tydligt ljud när det andas in.",
          "Besvären är ofta värst på kvällen och natten. Ett lindrigt anfall ger ingen eller bara lätt ansträngd andning när barnet är lugnt. Vid svårare krupp kan barnet få stridor även i vila, andas snabbare och använda extra muskler för att få luft. Då kan huden dras in mellan revbenen, vid nyckelbenen eller i halsgropen."
        ],
        bullets: [
          "Skällande, hård hosta.",
          "Hes röst.",
          "Pipande eller väsande ljud, framför allt vid inandning.",
          "Besvär som ofta ökar när barnet ligger ner, gråter eller blir oroligt.",
          "Vid svårare anfall: snabb andning, indragningar och påverkat allmäntillstånd."
        ]
      },
      {
        id: "orsak-och-smitta",
        title: "Vad orsakar krupp och hur smittar det?",
        body: [
          "Krupp orsakas av flera vanliga luftvägsvirus. Parainfluensavirus är en vanlig orsak, men även influensa- och RS-virus kan utlösa krupp. Det är alltså virusinfektionen som smittar, inte själva svullnaden i struphuvudet.",
          "Luftvägsvirus kan spridas genom droppar vid hosta och nysningar samt via händer och föremål. God handhygien, hosta i armvecket och att stanna hemma vid tydliga luftvägssymtom minskar smittspridningen. Krupp är vanligast under höst och vinter och drabbar framför allt yngre barn."
        ]
      },
      {
        id: "egenvard-krupp",
        title: "Vad kan du göra hemma vid krupp?",
        body: [
          "Ta upp barnet och låt det sitta upprätt i famnen eller stå upp. Försök att vara lugn och trösta barnet, eftersom gråt och oro kan göra andningen mer ansträngd. Det kan hjälpa att öppna ett fönster eller gå ut en kort stund så att barnet får andas sval luft.",
          "Erbjud dryck om barnet vill och kan dricka utan att andningen blir mer ansträngd. Vid nästäppa kan näsdroppar eller nässprej som passar barnets ålder göra det lättare att andas genom näsan; följ förpackningens anvisningar. Lämna inte barnet ensamt under pågående andningsbesvär och bedöm om symtomen tydligt lättar inom 15–30 minuter."
        ],
        bullets: [
          "Håll barnet upprätt.",
          "Skapa lugn och undvik sådant som gör barnet mer upprört.",
          "Prova sval luft om barnet tolererar det.",
          "Erbjud små mängder dryck.",
          "Ring 1177 om du är osäker på andningen eller vart ni ska vända er."
        ]
      },
      {
        id: "utredning-och-behandling",
        title: "Så bedöms och behandlas krupp i vården",
        body: [
          "Diagnosen ställs vanligen utifrån symtomen och en kroppsundersökning. Vårdpersonalen bedömer bland annat barnets allmäntillstånd, andningsfrekvens, ljud vid inandning, indragningar, puls och syresättning. Provtagning eller röntgen behövs oftast inte vid en typisk bild.",
          "Vid mer uttalade besvär kan vården ge kortison för att minska inflammationen och svullnaden. Inhalerat adrenalin kan användas när snabb effekt behövs, och barnet observeras då en tid eftersom effekten kan avta. Syrgas kan behövas vid svårare andningspåverkan. Antibiotika hjälper inte mot okomplicerad krupp eftersom orsaken är virus. Ge inte receptbelagda läkemedel på egen hand."
        ]
      },
      {
        id: "andra-orsaker-ljudlig-andning",
        title: "Krupp eller något annat?",
        body: [
          "All ljudlig andning är inte krupp. Astma eller obstruktiv bronkit ger oftare pip vid utandning, medan krupp typiskt ger ljud vid inandning och skällande hosta. Ett främmande föremål i luftvägen ska misstänkas om besvären börjar mycket plötsligt, till exempel när barnet äter eller leker med små saker.",
          "Hög feber, mycket ont i halsen, dregling och svårighet att svälja saliv tillsammans med andningsbesvär kan tala för ett annat allvarligt tillstånd. Ring då 112. Försök inte undersöka djupt i barnets hals hemma."
        ]
      },
      {
        id: "forlopp-och-forskola",
        title: "Hur länge varar krupp och när kan barnet gå tillbaka?",
        body: [
          "Kruppbesvären brukar pågå i ett till två dygn och varar sällan längre än en vecka. Hostan kan finnas kvar när den mest ansträngda andningen har gått över. En del barn får nya kruppanfall vid senare virusinfektioner, men benägenheten minskar oftast när luftvägarna blir större.",
          "Barnet kan återgå till förskola eller skola när det orkar delta i verksamheten som vanligt och har varit feberfritt i ett dygn utan febernedsättande läkemedel. Lite kvarvarande snuva eller lätt hosta behöver inte i sig hindra återgång om barnet mår bra."
        ]
      },
      {
        id: "nar-soka-vard-krupp",
        title: "När ska du söka vård för krupp hos barn?",
        body: [
          "Kontakta genast en vårdcentral eller jouröppen mottagning om barnet har andningsbesvär som inte lättar inom 15–30 minuter trots att barnet sitter upprätt, eller om barnet är mycket hängigt, svårt att få kontakt med eller inte orkar äta. Om mottagningarna är stängda ska ni söka akutmottagning. Ring 1177 om du behöver hjälp att bedöma symtomen eller vart ni ska åka.",
          "Ring 112 om barnet har mycket svårt att andas, om huden eller läpparna blir bleka eller blåaktiga, eller om barnet har svårt att andas och huden dras in mellan revbenen och i halsgropen. Ring också 112 vid plötsliga andningsbesvär där ett föremål kan ha fastnat, eller vid andningsbesvär tillsammans med hög feber, svår halssmärta, dregling och svårighet att svälja saliv."
        ],
        bullets: [
          "Ring 112 vid mycket svår andning, blek eller blåaktig hud eller tydliga indragningar.",
          "Ring 112 om barnet kan ha fått något i luftvägen.",
          "Sök genast vård om besvären inte lättar inom 15–30 minuter i upprätt läge.",
          "Sök genast vård om barnet blir mycket hängigt, svårkontaktbart eller inte orkar äta.",
          "Ring 1177 vid osäkerhet om barnets andning eller vårdnivå."
        ]
      }
    ],
    faq: [
      {
        question: "Hur låter krupphosta?",
        answer: "Hostan brukar beskrivas som skällande och hård. Barnet kan också vara hest och få ett pipande eller väsande ljud när det andas in."
      },
      {
        question: "Hjälper kall eller sval luft vid krupp?",
        answer: "Sval luft hjälper ofta och kan provas genom att öppna ett fönster eller gå ut en kort stund. Håll samtidigt barnet upprätt och lugnt. Sök vård om andningen inte tydligt lättar."
      },
      {
        question: "Hur länge brukar ett kruppanfall pågå?",
        answer: "Besvären brukar vara tydligast under en eller ett par nätter. Krupp pågår oftast i ett till två dygn och sällan längre än en vecka."
      },
      {
        question: "Kan krupp komma tillbaka?",
        answer: "Ja. Vissa barn får krupp vid flera virusinfektioner. Besvären brukar minska när barnet blir äldre och luftvägarna blir större."
      },
      {
        question: "Behövs antibiotika vid krupp?",
        answer: "Nej, vanlig krupp orsakas av virus och behandlas inte med antibiotika. Vid mer uttalade besvär kan vården ge kortison och ibland inhalerat adrenalin."
      },
      {
        question: "När ska jag ringa 112 vid krupp?",
        answer: "Ring 112 om barnet har mycket svårt att andas, blir blekt eller blåaktigt eller har andningsbesvär med tydliga indragningar mellan revbenen och i halsgropen."
      }
    ],
    sources: [
      {
        title: "Krupp",
        publisher: "1177",
        url: "https://www.1177.se/barn--gravid/vanliga-besvar-och-sjukdomar-hos-barn/vanliga-sjukdomar-och-besvar-hos-barn--aldre-an-1-ar/krupp/"
      },
      {
        title: "Viruskrupp hos barn",
        publisher: "1177 för vårdpersonal – nationellt kliniskt kunskapsstöd",
        url: "https://vardpersonal.1177.se/kunskapsstod/kliniska-kunskapsstod/viruskrupp-hos-barn/"
      },
      {
        title: "När barn har svårt att andas",
        publisher: "1177",
        url: "https://www.1177.se/sjukdomar--besvar/lungor-och-luftvagar/andningssvarigheter-och-andningsuppehall/nar-barn-har-svart-att-andas/"
      },
      {
        title: "Sjukdomsinformation om parainfluensavirus",
        publisher: "Folkhälsomyndigheten",
        url: "https://www.folkhalsomyndigheten.se/vara-amnesomraden/smittsamma-sjukdomar/smittsam-sjukdom/sjukdomsinformation-om-parainfluensavirus/"
      }
    ],
    cta: {
      title: "Behöver ditt barn bedömas?",
      body: "Läs vår guide om barn- och ungdomshälsa för vägledning om vanliga besvär och vilket vårdsteg som kan vara lämpligt.",
      bullets: [
        "Information om vanliga symtom hos barn",
        "Råd om när vården bör kontaktas",
        "Vägledning för föräldrar och vårdnadshavare"
      ],
      note: "Ring 1177 för sjukvårdsrådgivning. Ring 112 vid allvarliga andningsbesvär.",
      label: "Läs om barn- och ungdomshälsa",
      href: "/vardguiden/barn-ungdomshalsa"
    }
  },
  {
    slug: "rs-virus-barn-symtom",
    title: "RS-virus hos barn – symtom, smitta och när du söker vård",
    h1: "RS-virus hos barn: symtom och när du ska söka vård",
    seoTitle: "RS-virus hos barn: symtom och vårdråd",
    metaDescription: "RS-virus liknar ofta en förkylning men kan ge andningsbesvär hos spädbarn. Läs om symtom, egenvård, smitta, skydd och när du ska söka vård för ditt barn.",
    tag: "BARNHÄLSA",
    date: "september 14, 2026",
    publishedAtIso: "2026-09-14",
    image: "/bilder/artiklar/rs-virus-barn.webp",
    imageAlt: "Illustration av en vuxen som håller ett sovande spädbarn i en lugn hemmiljö.",
    authorName: "Hemläkare.se redaktion",
    targetQuery: "RS-virus hos barn",
    excerpt: "RS-virus hos barn börjar oftast som en förkylning. Hos spädbarn kan infektionen göra det svårt att andas och äta. Här får du veta vad du ska observera och när vård behövs.",
    summary: "RS-virus hos barn ger oftast snuva, hosta och ibland feber. Små barn kan få pipande eller ansträngd andning och orka äta sämre. Håll särskilt koll på andningen, vätskeintaget och hur barnet reagerar på kontakt. Ring 1177 för råd utifrån barnets ålder och symtom. Ring 112 om barnet har svårt att andas.",
    keyTakeaways: [
      "De flesta barn får en lindrig, förkylningsliknande infektion.",
      "Spädbarn, för tidigt födda barn och barn med vissa grundsjukdomar har högre risk för svår sjukdom.",
      "Ge vätska eller mat i små mängder ofta och hjälp barnet att hålla näsan fri med koksalt.",
      "Det går inte att avgöra säkert hemma om en förkylning orsakas av RS-virus; prov tas när vården bedömer att det behövs.",
      "Andningssvårigheter eller andningsuppehåll kräver akut hjälp via 112."
    ],
    body: "RS-virus hos barn är en vanlig luftvägsinfektion. RS står för respiratoriskt syncytialvirus. Nästan alla barn smittas någon gång under sina första levnadsår, men infektionen kan komma flera gånger eftersom genomgången sjukdom inte ger ett bestående skydd. Smittan är vanligast under höst och vinter.\n\nFör de flesta liknar RS-virus en vanlig förkylning. Hos framför allt spädbarn kan infektionen gå längre ner i luftvägarna och orsaka bronkiolit, en inflammation i de minsta luftrören. Då kan barnet få svårt att andas och äta. Det viktigaste är därför inte att själv försöka fastställa vilket virus barnet har, utan att följa andningen, vätskeintaget och allmäntillståndet. Informationen här är generell och ersätter inte en individuell medicinsk bedömning.",
    sections: [
      {
        id: "symtom-rs-virus-barn",
        title: "Symtom på RS-virus hos barn",
        body: [
          "De första symtomen är ofta snuva, nästäppa, hosta och feber. Barnet kan också få svårare att amma, äta eller dricka. Hostan kan tillta efter några dagar och sedan finnas kvar längre än de övriga förkylningssymtomen.",
          "När de mindre luftvägarna påverkas kan barnet andas snabbare, få pipande andningsljud eller behöva arbeta mer för varje andetag. Hos mycket små barn kan korta andningsuppehåll, så kallade apnéer, förekomma. Kontakta vården utifrån symtom och ålder i stället för att vänta på att alla typiska tecken ska uppstå."
        ],
        bullets: [
          "Snuva eller täppt näsa.",
          "Hosta, ibland med pipande andning.",
          "Feber, men feber behöver inte alltid finnas.",
          "Svårt att amma, äta eller dricka.",
          "Snabb eller ansträngd andning."
        ]
      },
      {
        id: "risk-allvarlig-sjukdom",
        title: "Vilka barn riskerar att bli mer sjuka?",
        body: [
          "Barn under sex månader har större risk att bli allvarligt sjuka. Risken är särskilt viktig att beakta hos de yngsta spädbarnen, barn som föddes för tidigt och barn med vissa sjukdomar i hjärtat, lungorna eller nervsystemet.",
          "Ett litet barn kan bli uttröttat av att både andas och äta. Minskad ork vid matning kan därför vara ett viktigt tecken även om hostan inte låter dramatisk. Om du är osäker på ett spädbarns symtom bör du ringa 1177 för individuell rådgivning."
        ]
      },
      {
        id: "diagnos-och-behandling",
        title: "Så bedöms och behandlas RS-virus",
        body: [
          "Det går inte att skilja RS-virus säkert från andra luftvägsvirus enbart på symtomen. Provtagning behövs inte alltid vid en lindrig infektion. Vården kan ta prov när resultatet påverkar handläggningen, till exempel om barnet är så påverkat att sjukhusvård kan behövas.",
          "Det finns ingen rutinbehandling som tar bort själva virusinfektionen. På sjukhus kan ett svårt sjukt barn få hjälp med vätska och näring samt stöd för andningen. Antibiotika hjälper inte mot RS-virus, men kan bli aktuellt om läkare samtidigt konstaterar en bakteriell infektion."
        ]
      },
      {
        id: "egenvard-hemma",
        title: "Vad kan du göra hemma?",
        body: [
          "Egenvården syftar till att underlätta andning och matning. Koksaltdroppar i näsan och en nässug avsedd för barn kan hjälpa när nästäppan gör det svårt att äta. Erbjud vätska eller mat oftare och i mindre mängder om barnet snabbt blir trött.",
          "Följ hur barnet andas, hur mycket det får i sig och om det kissar ungefär som vanligt. Febernedsättande läkemedel kan användas om barnet mår tydligt dåligt av febern, men följ förpackningens anvisningar. Prata med läkare innan du ger sådana läkemedel till barn under sex månader."
        ],
        bullets: [
          "Erbjud små mängder vätska eller mat ofta.",
          "Använd koksalt i näsan vid nästäppa.",
          "Låt barnet vila och följ andningen regelbundet.",
          "Undvik tobaksrök och andra ämnen som irriterar luftvägarna.",
          "Ring 1177 om du är osäker på barnets symtom eller vätskeintag."
        ]
      },
      {
        id: "smitta-och-forebyggande",
        title: "Hur smittar RS-virus?",
        body: [
          "RS-virus sprids genom droppar vid hosta och nysningar samt genom direkt och indirekt kontakt. Virus kan föras vidare via händer, leksaker och andra föremål som någon med infektionen har rört vid.",
          "Tvätta händerna ofta, särskilt innan du tar i ett spädbarn. Undvik att låta förkylda personer träffa barnet och välj om möjligt mindre trånga miljöer under säsongen. Åtgärderna minskar risken men kan inte ta bort den helt."
        ]
      },
      {
        id: "skydd-nyfodda-2026",
        title: "Skydd mot RS-virus för nyfödda 2026",
        body: [
          "Under säsongen 2026–2027 erbjuds barn som föds från och med den 10 september 2026 förebyggande antikroppar mot RS-virus. Antikropparna ges efter födseln och skyddar under de första månaderna, när spädbarn är som känsligast. Folkhälsomyndigheten anger att behandlingen är kostnadsfri och erbjuds i alla regioner.",
          "Det finns också vaccin som kan ges under graviditet för att skydda barnet efter födseln. Det är inte samma sak som antikroppsbehandlingen till barnet. Vad som är lämpligt kan bero på tidpunkt i graviditeten, beräknad förlossning och andra medicinska faktorer. Fråga barnmorskemottagning, BB eller läkare om vad som gäller i det enskilda fallet."
        ]
      },
      {
        id: "nar-soka-vard-rs-virus",
        title: "När ska du söka vård för RS-virus hos barn?",
        body: [
          "Barnets ålder, andning, vätskeintag och allmäntillstånd avgör hur bråttom det är. Ring 1177 om barnet är litet, äter eller dricker tydligt sämre, eller om du är osäker på andningen. Sök vård skyndsamt om barnet blir slött, kissar betydligt mindre än vanligt eller försämras.",
          "Ring 112 om barnet har svårt att andas eller får andningsuppehåll. Tecken på andningspåverkan kan vara att barnet andas snabbt, att varje andetag verkar jobbigt eller att barnet inte orkar äta på grund av andningen. Vänta inte på att fler symtom ska tillkomma om barnet har tydliga andningssvårigheter."
        ],
        bullets: [
          "Ring 112 vid andningssvårigheter eller andningsuppehåll.",
          "Ring 1177 för rådgivning om ett spädbarn har förkylningssymtom och du är osäker på läget.",
          "Sök vård skyndsamt om barnet inte orkar dricka, kissar betydligt mindre eller blir allt slöare.",
          "Låt vården bedöma barnet om andningen blir snabbare eller mer ansträngd."
        ]
      }
    ],
    faq: [
      {
        question: "Hur vet jag om mitt barn har RS-virus?",
        answer: "Symtomen kan inte säkert skiljas från andra luftvägsvirus hemma. Vården tar prov när det bedöms behövas, framför allt om resultatet påverkar handläggningen."
      },
      {
        question: "Hur länge är ett barn sjukt i RS-virus?",
        answer: "De flesta blir friska inom en till två veckor, men hostan kan finnas kvar längre. Sök råd om barnet försämras eller om du oroar dig för andning och vätskeintag."
      },
      {
        question: "Kan barnet få RS-virus flera gånger?",
        answer: "Ja. En genomgången infektion ger inte ett bestående skydd, så både barn och vuxna kan smittas igen. Senare infektioner är ofta lindrigare."
      },
      {
        question: "Hjälper antibiotika mot RS-virus?",
        answer: "Nej, antibiotika verkar mot bakterier och inte mot virus. Antibiotika kan bara bli aktuellt om läkare bedömer att barnet samtidigt har en bakteriell infektion."
      },
      {
        question: "Får alla nyfödda skydd mot RS-virus?",
        answer: "Under säsongen 2026–2027 erbjuds förebyggande antikroppar till barn som föds från och med den 10 september 2026. Fråga BB eller barnets vårdgivare vad som gäller för just barnet."
      },
      {
        question: "När ska jag ringa 112?",
        answer: "Ring 112 om barnet har svårt att andas eller får andningsuppehåll. Vänta inte på att fler symtom ska tillkomma vid tydliga andningssvårigheter."
      }
    ],
    sources: [
      {
        title: "RS-virus hos barn",
        publisher: "1177",
        url: "https://www.1177.se/sv-se-x-ll/Stockholm/sjukdomar--besvar/lungor-och-luftvagar/inflammation-och-infektion-ilungor-och-luftror/rs-virus-hos-barn/"
      },
      {
        title: "Sjukdomsinformation om RS-virusinfektion",
        publisher: "Folkhälsomyndigheten",
        url: "https://www.folkhalsomyndigheten.se/vara-amnesomraden/smittsamma-sjukdomar/smittsam-sjukdom/sjukdomsinformation-om-rs-virusinfektion/"
      },
      {
        title: "Frågor och svar om profylax mot RSV-infektion för barn",
        publisher: "Folkhälsomyndigheten",
        url: "https://www.folkhalsomyndigheten.se/vara-amnesomraden/vaccinationer/rekommendationer-om-vaccination/rekommendationer-om-vaccination-under-graviditet-och-skydd-for-nyfodda/fragor-och-svar-om-profylax-mot-rsv-infektion-for-barn/"
      },
      {
        title: "Profylax till barn vid RSV-infektion",
        publisher: "Läkemedelsverket",
        url: "https://www.lakemedelsverket.se/sv/behandling-och-forskrivning/behandlingsrekommendationer/sok-behandlingsrekommendationer/lakemedel-vid-infektion-med-respiratoriskt-syncytievirus-rsv-behandlingsrekommendation/profylax-till-barn"
      },
      {
        title: "Vätskebrist och uttorkning hos barn",
        publisher: "1177",
        url: "https://www.1177.se/sjukdomar--besvar/mage-och-tarm/magsjuka-och-krakningar/vatskebrist-och-uttorkning-hos-barn/"
      }
    ],
    cta: {
      title: "Behöver ditt barn bedömas?",
      body: "Läs vår guide om barn- och ungdomshälsa för information om vanliga besvär och vilket vårdsteg som kan vara lämpligt.",
      bullets: [
        "Vägledning om vanliga symtom hos barn",
        "Råd om när vård bör kontaktas",
        "Information för föräldrar och vårdnadshavare"
      ],
      note: "Ring 1177 för sjukvårdsrådgivning. Ring 112 vid andningssvårigheter.",
      label: "Läs om barn- och ungdomshälsa",
      href: "/vardguiden/barn-ungdomshalsa"
    }
  },
