...
export default async function ServicePage({ params }: PageProps) {
  ...
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": `${SITE_URL}/${service.slug}#webpage`,
        url: `${SITE_URL}/${service.slug}`,
        name: service.seoTitle,
        description: service.metaDescription,
        inLanguage: "sv-SE",
        about: { "@id": `${SITE_URL}/${service.slug}#service` },
      },
      {
        "@type": "Service",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: service.name, item: `${SITE_URL}/${service.slug}` },
        ],
      },
      {
        "@type": "FAQPage",
          ...
          <div className="min-w-0 space-y-12 sm:space-y-16">
            ...
            <section aria-labelledby="relaterade">
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-3">
                {related.map((item) => (
                  <Link key={item.slug} href={`/${item.slug}`} className="group rounded-2xl border border-gray-200 p-5 transition hover:-translate-y-0.5 hover:border-pink-200 hover:shadow-lg">
